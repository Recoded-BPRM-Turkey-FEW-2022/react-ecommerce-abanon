  ...
  return (
    <>
      <BottomNavigation
        ...
        style={{ background: "#c96f53", position: "static", bottom: "0" }}
      >
          ...
          <div className="footer">
            ...
            <div className="icon">
              <IconButton
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/ghofran-adel-9222a4208/"
                  )
                }
              >
                <GitHubIcon />
              ...
              <IconButton
                className="icon"
                aria-label="Linkedin.com"
                onClick={() => window.open("https://github.com/ghufran-adel")}
              >
                <LinkedInIcon />
              </IconButton>
            </div>
          ...
          <div className="footer">
            ...
            <div className="icon">
              <IconButton
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/abdelrahman-sherif-mostafa"
                  )
                }
              >
                <GitHubIcon />
              ...
              <IconButton
                ...
                aria-label="Linkedin.com"
                onClick={() =>
                  window.open("https://github.com/AbdelrahmanSherf")
                }
              >
                <LinkedInIcon />
              </IconButton>
